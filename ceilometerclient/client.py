...
class AuthPlugin(auth.BaseAuthPlugin):
    ...
    def _get_ks_kwargs(self, http_timeout):
        ...
        ks_kwargs = {
            ...
            'user_domain_id': self.opts.get('user_domain_id') if self.opts.get('user_domain_id') else 'default',
            'user_domain_name': self.opts.get('user_domain_name') if self.opts.get('user_domain_name') else 'default',
            'project_id': project_id,
            'project_name': project_name,
            'project_domain_name': self.opts.get('project_domain_name'),
            'project_domain_id': self.opts.get('project_domain_id') if self.opts.get('project_domain_id') else 'default',
