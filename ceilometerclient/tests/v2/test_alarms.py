...
AN_ALARM = {u'alarm_actions': [u'http://site:8000/alarm'],
            ...
            u'type': u'threshold',
            u'threshold_rule': {
                u'query': [{u'field': u'meter',
                            u'op': u'eq',
                            u'value': u'storage.objects'},
                           {u'field': u'key_name',
                            u'op': u'eq',
                            u'value': u'key_value'}],
...
fixtures = {
    ...
    '/v2/alarms/alarm-id/state/alarm':
    {
        'PUT': (
            {},
            None
...
class AlarmManagerTest(testtools.TestCase):
    ...
    def test_set_state(self):
        self.mgr.set_state(alarm_id='alarm-id', state='alarm')
        expect = [
            ('PUT', '/v2/alarms/alarm-id/state/alarm', {}, None),
        ]
        self.assertEqual(self.api.calls, expect)
