...
class BuildUrlTest(utils.BaseTestCase):
    ...
    def test_one(self):
        url = options.build_url('/', [{'field': 'this',
                                       'op': 'gt',
                                       'value': 43}])
        self.assertEqual('/?q.field=this&q.op=gt&q.type=&q.value=43', url)
    ...
    def test_two(self):
        ...
        self.assertEqual('/?%s&%s&%s&%s' % (fields, ops, types, vals), url)

    def test_default_op(self):
        url = options.build_url('/', [{'field': 'this',
                                       'value': 43}])
        self.assertEqual('/?q.field=this&q.op=&q.type=&q.value=43', url)

    def test_one_param(self):
        url = options.build_url('/', None, ['period=60'])
        self.assertEqual('/?period=60', url)

    def test_two_params(self):
        url = options.build_url('/', None, ['period=60',
                                            'others=value'])
        self.assertEqual('/?period=60&others=value', url)
...
class CliTest(utils.BaseTestCase):
    ...
    def test_one(self):
        ...
        self.assertEqual([{'field': 'this', 'op': 'le',
                           'value': '34', 'type': ''}], ar)
    ...
    def test_negative(self):
        ...
        self.assertEqual([{'field': 'this', 'op': 'ge',
                           'value': '-783', 'type': ''}], ar)
    ...
    def test_with_incorrect_type(self):
        ...
        self.assertEqual([{'field': 'timestamp',
                           'op': 'eq',
                           'type': '',
                           'value': 'invalid::sometimestamp'}], ar)
    ...
    def test_with_single_colon(self):
        ...
        self.assertEqual([{'field': 'timestamp',
                           'op': 'eq',
                           'type': '',
                           'value': 'datetime:sometimestamp'}], ar)
