...
class ClientTest(utils.BaseTestCase):
    ...
    def create_client(self, api_version=1, exclude=[]):
    ...
    def test_client_version(self):
        ...
        self.assertEqual(isinstance(c1, v1client.Client), True)

        c2 = self.create_client(api_version=2)
        self.assertEqual(isinstance(c2, v2client.Client), True)

    def test_client_auth_lambda(self):
        FAKE_ENV['os_auth_token'] = lambda: FAKE_ENV['os_auth_token']
        self.assertEqual(isinstance(FAKE_ENV['os_auth_token'],
