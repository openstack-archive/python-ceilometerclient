...
''', sys.stdout.getvalue())
    ...
    def test_do_alarm_gnocchi_aggr_by_metrics_threshold_create(self):
        ...
        self.cc.alarms.create.return_value = alarm
        ceilometer_shell.
        do_alarm_gnocchi_aggregation_by_metrics_threshold_create(self.cc,
                                                                 self.args)
        self.assertEqual('''\
+---------------------------+------------------------------------------\
----------------------------+
...
''', sys.stdout.getvalue())
    ...
    def test_do_alarm_gnocchi_aggr_by_resources_threshold_create(self):
        ...
        self.cc.alarms.create.return_value = alarm
        ceilometer_shell.
        do_alarm_gnocchi_aggregation_by_resources_threshold_create(self.cc,
                                                                   self.args)
        self.assertEqual('''\
+---------------------------+------------------------------------------------+
| Property                  | Value                                          |
...
class ShellEmptyIdTest(utils.BaseTestCase):
    ...
    def test_alarm_gnocchi_resources_threshold_update_with_empty_id(self):
        self._test_alarm_action_with_empty_ids('alarm-gnocchi-resources-threshold-update')

    def test_alarm_gnocchi_aggr_by_resources_threshold_update_with_empty_id(self):
        self._test_alarm_action_with_empty_ids('alarm-gnocchi-aggregation-by-resources-threshold-update')

    def test_alarm_gnocchi_aggr_by_metrics_threshold_update_with_empty_id(self):
        self._test_alarm_action_with_empty_ids('alarm-gnocchi-aggregation-by-metrics-threshold-update')
