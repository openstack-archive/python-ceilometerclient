...
class CeilometerShell(object):
    ...
    def _append_identity_args(self, parser):
        ...
        parser.add_argument('--cert-file',
                            dest='os_cert',
                            help='DEPRECATED! Use --os-cert. Path of'
                            ' certificate file to use in SSL connection.'
                            ' This file can optionally be prepended with the'
                            ' private key.')

        parser.add_argument('--key-file',
                            help='DEPRECATED! Use --os-key. Path of client key'
                            ' to use in SSL connection. This option is not'
                            ' necessary if your key is prepended to your cert'
                            ' file.')
    ...
    def main(self, argv):
        ...
        if not (args.os_auth_token and args.ceilometer_url):
            ...
            # stir users towards Keystone V3 API
            if not (args.os_project_id or 
                (args.os_project_name and args.os_domain_is):
